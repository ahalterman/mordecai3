...
no WikiDocs cap; this arm adds `--aux-class-weight 0.1`.
...
for S in 42 101 202 617 1848; do
  WANDB_MODE=offline uv run python tools/train.py train --epochs 15 --mix-dim 512 \
    ...
    --aux-class-weight 0.1 --seed $S \
    --metrics-out experiments/e22_class01/seed$S.json > experiments/e22_class01/seed$S.log 2>&1
done
```
...
Auxiliary 10-way feature-class head (A/P/S/T/H/L/R/U/V + other), weight 0.1. Flat.
