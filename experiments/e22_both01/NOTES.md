...
no WikiDocs cap; this arm adds `--aux-country-weight 0.1 --aux-class-weight 0.1`.
...
for S in 42 101 202 617 1848; do
  WANDB_MODE=offline uv run python tools/train.py train --epochs 15 --mix-dim 512 \
    ...
    --aux-country-weight 0.1 --aux-class-weight 0.1 --seed $S \
    --metrics-out experiments/e22_both01/seed$S.json > experiments/e22_both01/seed$S.log 2>&1
done
```
...
Both auxiliary heads. Flat on EM, +0.0009 acc@161. No interaction worth having.
